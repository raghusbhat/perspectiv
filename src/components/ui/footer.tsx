          ...
          <div className="lg:col-span-1">
            <div className="space-y-3 sm:space-y-4">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                AI platform, rugged hardware, and consulting to automate defect
                detection, measurement, and process optimization across
                industries.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-xs sm:text-sm text-muted-foreground">
                  ...
                  <li>
                    <Link
                      to="/industries/garments-textiles"
                      className="hover:text-secondary transition-colors"
                    >
                      Garments & Textiles
                    </Link>
                  ...
                  <li>
                    <Link
                      to="/industries/general-manufacturing"
                      className="hover:text-secondary transition-colors"
                    >
                ...
                <ul className="space-y-2 text-xs sm:text-sm text-muted-foreground">
                  <li>
                    <button
                      onClick={() => {
                        const email =
                          "contact" + "@" + "perspectiv" + "." + "in";
                        window.location.href = "mailto:" + email;
                      }}
                      className="hover:text-secondary transition-colors cursor-pointer text-left"
                    >
                      contact<span className="select-none">&#8203;</span>@
                      <span className="select-none">&#8203;</span>perspectiv
                      <span className="select-none">&#8203;</span>.
                      <span className="select-none">&#8203;</span>in
                    </button>
                  </li>
                  <li>
                    <button
                      ...
                      className="hover:text-secondary transition-colors cursor-pointer text-left"
                    >
                      +91<span className="select-none">&#8203;</span>-
                      <span className="select-none">&#8203;</span>9591
                      <span className="select-none">&#8203;</span>084
                      <span className="select-none">&#8203;</span>455
                    </button>
                  </li>
                  <li>
                    <a
        ...
        <div className="border-t border-border/40 pt-6 sm:pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
            ...
            <p className="text-xs sm:text-sm text-muted-foreground">
              © {new Date().getFullYear()} Perspectiv Labs® LLC. All Rights
              Reserved.
            </p>

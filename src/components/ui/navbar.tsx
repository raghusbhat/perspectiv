...
const navItems: NavItem[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        to: "/software/pipeline-designer",
        icon: Workflow,
        description: "Visual pipeline builder for inspection workflows",
      },
      {
        name: "Model Management",
        to: "/software/model-management",
        icon: Database,
        description: "AI model versioning and deployment management",
      },
      {
        name: "Integrations & APIs",
        to: "/software/integrations",
        icon: Plug,
        description: "Connect with existing manufacturing systems",
      },
      {
